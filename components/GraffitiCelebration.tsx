...
export function GraffitiCelebration({ show, onComplete }: GraffitiCelebrationProps) {
  ...
  useEffect(() => {
    if (show) {
      ...
      const randomMessage = graffitiMessages[Math.floor(Math.random() * graffitiMessages.length)];
